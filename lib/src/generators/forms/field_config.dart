...
extension ExecutableElementDataExtension on ExecutableElement2? {
  String? get validatorPath => this?.firstFragment.libraryFragment?.source.uri.toString();
  String? get validatorName => hasEnclosingElementName
      ? '$enclosingElementName.${this?.displayName}'
      : this?.displayName;
  bool get hasEnclosingElementName => enclosingElementName != null;
  String? get enclosingElementName => this?.enclosingElement2?.displayName;
}
